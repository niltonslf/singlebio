...
export default function Home() {
  return (
    <main className='via-background-200 flex h-[100vh] w-screen flex-col bg-gradient-to-tr from-base-100 via-base-300 to-base-100 p-5'>
      ...
      <section className='max:w-full mx-auto mt-14 flex w-full flex-row items-center justify-center md:max-w-6xl'>
        ...
        <div className='w-35% ml-auto flex h-full flex-row items-center justify-center'>
          <div className='rotate-[7deg] rounded-2xl '>
            <Image src='/home/model.png' alt='model' width={300} height={700} />
          </div>
        </div>
      </section>
    </main>
